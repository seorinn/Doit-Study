...
namespace StudentManager.Data.Controllers
{
    ...
    public class TestScoresController : ControllerBase
    {
        ...
        [HttpGet("testscoreId={id:length(9)}")]
        ...
        public async Task<IActionResult> DeleteAsync(string id)
        {
            ...
            await _testScoreTest.RemoveAsync(score.Id);

            return NoContent();
        }

        [HttpDelete("testscoreId={id:length(9)}")]
        public async Task<ActionResult<TestScore>> DeleteByIdAsync(string id)
        {
            var score = await _testScoreTest.GetByTestScoreIdAsync(id);
